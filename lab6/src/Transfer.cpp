...
namespace dataflow
{
  ...
  Domain *eval(BinaryOperator *BinOp, const Memory *InMem)
  {
     ...
     */
    auto *oper1 = BinOp->getOperand(0);
    auto *oper2 = BinOp->getOperand(1);
    Domain *d1 = getOrExtract(InMem, oper1);
    Domain *d2 = getOrExtract(InMem, oper2);

    char opcode = BinOp->getOpcode();
    switch (opcode)
    {
    case Instruction::Add:
      return Domain::add(d1, d2);
    case Instruction::Sub:
      return Domain::sub(d1, d2);
    case Instruction::Mul:
      return Domain::mul(d1, d2);
    case Instruction::UDiv:
    case Instruction::SDiv:
      return Domain::div(d1, d2);
    default:
  ...
  Domain *eval(CmpInst *Cmp, const Memory *InMem)
  {
     ...
     */
    auto *oper1 = Cmp->getOperand(0);
    auto *oper2 = Cmp->getOperand(1);
    Domain *d1 = getOrExtract(InMem, oper1);
    Domain *d2 = getOrExtract(InMem, oper2);
